...
const char NAME_INITIAL_BIT_PER_ERROR[] = "InitialBitPerError";
const char NAME_FINAL_BIT_PER_ERROR[] = "FinalBitPerError";
...
bool Config::setConfig(const char *name, const char *value) {
  ...
  else if (MATCH_NAME(NAME_INITIAL_BIT_PER_ERROR)) {
    initialBER = 1/strtof(value, nullptr);
  }
  else if (MATCH_NAME(NAME_FINAL_BIT_PER_ERROR)) {
    finalBER = 1/strtof(value, nullptr);
  }
  else if (MATCH_NAME(NAME_BER_SIGMA)) {
    normalSigma = strtof(value, nullptr);
  }
